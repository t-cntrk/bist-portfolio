...
export const translations = {
    tr: {
        ...
        // Sell modal
        'modal.sellTitle': 'Sat',
        'modal.sellQty': 'Satılacak Miktar',
        'modal.sellPrice': 'Satış Fiyatı (₺)',
        'modal.sellSubmit': 'Sat',
        'modal.sellAll': 'Tümü',
        'modal.sellAvailable': 'Mevcut',
        'modal.sellAvgCost': 'Ort. Maliyet',
        'modal.sellRealized': 'Tahmini K/Z',
        // Transaction history
        ...
        'tx.import': 'CSV İçe Aktar',
        'import.previewTitle': 'İçe Aktarma Önizlemesi',
        'import.previewHint': 'Aşağıdaki işlemler kronolojik olarak uygulanacak. Onaylamadan hiçbir şey kaydedilmez.',
        'import.stTotal': 'Toplam',
        'import.stSymbols': 'Varlık',
        'import.range': 'Tarih aralığı',
        'import.realizedTry': 'Gerçekleşen K/Z (₺)',
        'import.colSymbol': 'Varlık',
        'import.colType': 'Tür',
        'import.colQty': 'Miktar',
        'import.colAvg': 'Ort. Maliyet',
        'import.noPositions': 'Sonuç pozisyonu yok',
        'import.dupTitle': 'Yinelenen işlemler algılandı',
        'import.dupBody': 'Bu dosyadaki {n} işlem geçmişinizde zaten mevcut görünüyor. İçe aktarmak, bu işlemlerin yinelenen kopyalarını oluşturur (otomatik birleştirme yapılmaz).',
        'import.dupAck': 'Anladım, yine de içe aktar',
        'import.confirm': 'İçe Aktar',
        'import.importing': 'İçe aktarılıyor…',
        'import.success': 'İşlemler içe aktarıldı',
        'import.errEmpty': 'CSV boş veya yalnızca başlık satırı içeriyor',
        'import.errHeaders': 'Beklenen sütunlar eksik: ',
        'import.errFailed': 'İçe aktarma başarısız',
        // Messages
        ...
        'msg.sellSuccess': 'Satış başarıyla gerçekleşti',
        'msg.sellError': 'Satış hatası: ',
        'msg.sellQtyError': 'Miktar 0 ile mevcut miktar arasında olmalıdır',
    ...
    en: {
        ...
        'modal.addSubmit': 'Add',
        // Sell modal
        'modal.sellTitle': 'Sell',
        'modal.sellQty': 'Quantity to Sell',
        'modal.sellPrice': 'Sell Price (₺)',
        'modal.sellSubmit': 'Sell',
        'modal.sellAll': 'All',
        'modal.sellAvailable': 'Available',
        'modal.sellAvgCost': 'Avg Cost',
        'modal.sellRealized': 'Est. P/L',
        // Transaction history
        ...
        'tx.import': 'Import CSV',
        'import.previewTitle': 'Import Preview',
        'import.previewHint': 'The transactions below will be applied chronologically. Nothing is saved until you confirm.',
        'import.stTotal': 'Total',
        'import.stSymbols': 'Assets',
        'import.range': 'Date range',
        'import.realizedTry': 'Realized P/L (₺)',
        'import.colSymbol': 'Asset',
        'import.colType': 'Type',
        'import.colQty': 'Quantity',
        'import.colAvg': 'Avg. Cost',
        'import.noPositions': 'No resulting positions',
        'import.dupTitle': 'Duplicate transactions detected',
        'import.dupBody': '{n} transaction(s) in this file already appear in your history. Importing will create duplicate copies of them (no automatic merging is performed).',
        'import.dupAck': 'I understand, import anyway',
        'import.confirm': 'Import',
        'import.importing': 'Importing…',
        'import.success': 'Transactions imported',
        'import.errEmpty': 'CSV is empty or contains only a header row',
        'import.errHeaders': 'Missing expected columns: ',
        ...
        'msg.sellSuccess': 'Sale completed successfully',
        'msg.sellError': 'Sell error: ',
        'msg.sellQtyError': 'Quantity must be between 0 and the available amount',
