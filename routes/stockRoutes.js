...
const { yahooLimiter, chartLimiter } = require('../middleware/securityMiddleware');
 ...
 * @desc    Clear stock/FX cache (for force refresh)
 */
router.post('/stocks/clear-cache', yahooLimiter, stockController.clearCache);
